/*
 * XCoder v6.2.5560.21651
 * 作者：Stone/X
 * 时间：2015-04-25 11:54:07
...
namespace NewLife.OA
{
    ...
    public partial class TaskMember : Entity<TaskMember>
    {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(TaskMember).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new TaskMember();
        //    entity.WorkTaskID = 0;
        //    entity.MemberID = 0;
        //    entity.Kind = 0;
        //    entity.LastViewTime = DateTime.Now;
        //    entity.LastUpdateTime = DateTime.Now;
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(TaskMember).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static EntityList<TaskMember> FindAllByWorkTaskID(Int32 worktaskid)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<TaskMember> FindAllByMemberID(Int32 memberid)
        {
            if (Meta.Count >= 1000)
                return FindAll(_.MemberID, memberid);
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(__.MemberID, memberid);
        }
        ...
        //public static EntityList<TaskMember> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
