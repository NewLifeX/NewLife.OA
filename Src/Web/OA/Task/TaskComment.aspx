﻿<%@ Page Title="任务评论管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="TaskComment.aspx.cs" Inherits="OA_TaskComment" %>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <div class="toolbar">
        <XCL:LinkBox ID="lbAdd" runat="server" BoxHeight="355px" BoxWidth="440px" Url="TaskCommentForm.aspx"
            IconLeft="~/Admin/images/icons/new.gif" EnableViewState="false"><b>添加任务评论</b></XCL:LinkBox>
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="ods" AllowPaging="True" AllowSorting="True" CssClass="m_table" PageSize="20" CellPadding="0" GridLines="None" EnableModelValidation="True">
        <Columns>
            ...
            <asp:BoundField DataField="WorkTaskID" HeaderText="任务" SortExpression="WorkTaskID" DataFormatString="{0:n0}">
            ...
            <XCL:LinkBoxField HeaderText="编辑" DataNavigateUrlFields="ID" DataNavigateUrlFormatString="TaskCommentForm.aspx?ID={0}" Height="355px" Text="编辑" Width="440px" Title="编辑任务评论">
