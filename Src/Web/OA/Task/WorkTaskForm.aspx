...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <table border="0" class="m_table" cellspacing="1" cellpadding="0" align="Center">
        ...
        <tr>
            ...
            <td colspan="3"><asp:TextBox ID="frmName" runat="server" Width="150px"></asp:TextBox></td>
        </tr>
<tr>
            <td align="right">父任务：</td>
            <td colspan="3"><XCL:NumberBox ID="frmParentID" runat="server" Width="80px"></XCL:NumberBox></td>
        </tr>
<tr>
...
<tr>
            ...
            <td colspan="3"><asp:TextBox ID="frmRemark" runat="server" TextMode="MultiLine" Width="300px" Height="80px"></asp:TextBox></td>
        </tr>
<tr>
            <td align="right">状态：</td>
            <td colspan="3"><XCL:NumberBox ID="frmStatus" runat="server" Width="80px"></XCL:NumberBox></td>
        </tr>
<tr>
...
<tr>
            ...
            <td><asp:Label ID="frmCreateName" runat="server" Text="Label"></asp:Label></td>
