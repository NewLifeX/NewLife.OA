﻿<%@ Page Title="任务评论管理" Language="C#" MasterPageFile="~/Admin/ManagerPage.master" AutoEventWireup="true" CodeFile="TaskCommentForm.aspx.cs" Inherits="OA_TaskCommentForm"%>

<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="C">
    <table border="0" class="m_table" cellspacing="1" cellpadding="0" align="Center">
        <tr>
            <th colspan="2">任务评论</th>
        </tr>
        <tr>
    ...
    <table border="0" align="Center" width="100%">
        <tr>
            <td align="center">
                ...
                &nbsp;<asp:Button ID="btnCopy" runat="server" CausesValidation="True" Text='另存为新任务评论' />
